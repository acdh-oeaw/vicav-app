                     ...
                     <tr>
                        ...
                        <td class="tdKWICMain">
                           <xsl:for-each select="tei:form[@type='inflected']">
                               <xsl:if test="string-length(tei:orth[@xml:lang='ar-arz-x-cairo-vicav'])&gt;0">
                     ...
                     <tr>
                        ...
                        <td class="tdSense">
                           ...
                           <xsl:if test="tei:gramGrp/tei:gram[@type='arguments']">
                              <div class="dvDef">
                                 <xsl:value-of select="parent::tei:form[@type='lemma']/tei:orth[@xml:lang='ar-arz-x-cairo-vicav'] | parent::tei:form[@type='multiWordUnit']/tei:orth[@xml:lang='ar-arz-x-cairo-vicav'] | parent::tei:form[@type='abbrev']/tei:orth[@xml:lang='ar-arz-x-cairo-vicav']"/>
                           ...
                           <xsl:for-each select="tei:cit[@type='multiWordUnit'][@xml:lang='ar-arz-x-cairo-vicav']">
